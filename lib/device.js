  ...
  var debug = function () {
    ...
    if (debugElement) {
      debugElement.innerHTML =
        "<h4>DEBUG</h4>" + "<p>UA String: " + userAgent + "</p>" + "<p>Dimensions: " + window.innerWidth + 'x' + window.innerHeight + "</p>" + "<p>Orientation: " + window.orientation + "</p>" + "<p>CSS Classes: " + docElement.className + "</p>";
    }
  }
